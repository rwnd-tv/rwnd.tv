...
export function SeasonDetailPage() {
  ...
  // invalidate it separately. Closing the confirm dialog and clearing
  // selection is WatchHistoryTable's own job now (see its onDeleteSelected
  // doc comment).
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {seasonHasWatches && (
        <WatchHistoryTable
          watches={seasonWatchesData?.watches}
